 ...
 *  to read characters from standard input one at a time:
 *  <ul>
 *  <li> {@link #hasNextChar()}
 *  <li> {@link #readChar()}
 *  </ul>
...
public final class StdIn {
    ...
    /**
      ...
      * input is empty (except possibly for whitespace).
      * Use this method to know whether
      * the next call to {@link #readString()},
      * {@link #readDouble()}, etc will succeed.
      *
      * @return {@code true} if
      * standard input is empty (except possibly
    ...
    public static String readAll() {
        ...
        //reset delimeter, since now scanner is empty
        scanner.useDelimiter(WHITESPACE_PATTERN);
    ...
    /**
      ...
      * @throws InputMismatchException if
      * the next token cannot be parsed as a {@code double}
      */
    ...
    /**
      * Reads the next token from standard
      * input, parses it as a byte, and returns the byte.
      *
      * @return the next byte on standard input
      * @throws NoSuchElementException if standard input is empty
      * @throws InputMismatchException if
      * the next token cannot be parsed as a {@code byte}
      */
     ...
     *    {@code true} or {@code 1} for true,
     *    and {@code false} or {@code 0} for false,
     *    ignoring case
     */
     ...
     * standard input and returns them as an array of strings.
     * @return all remaining lines on
     * standard input, as an array of strings
     */
    ...
    /**
     * Reads all remaining tokens
     * from standard input, parses
     * them as integers, and returns
     * them as an array of integers.
     * @return all remaining integers
     * on standard input, as an array
     * @throws InputMismatchException if any token
